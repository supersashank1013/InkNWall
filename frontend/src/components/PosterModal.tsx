  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative z-10 mx-auto flex w-full max-w-[min(92vw,860px)] max-h-[92vh] items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
          show ? "scale-100 translate-y-0" : "scale-90 translate-y-10"
        }`}
      >

        {/* Glow frame */}
        <div className="absolute inset-0 m-auto h-[520px] w-[520px] rounded-3xl bg-gradient-to-br from-orange-500/20 to-orange-900/30 blur-xl opacity-70" />
